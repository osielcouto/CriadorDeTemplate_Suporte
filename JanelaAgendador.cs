...
{
    public partial class JanelaAgendador : Form
    {
        Thread tVoltar;
        public JanelaAgendador()
        {
            InitializeComponent();
        ...
        private void but_CriarTemplate_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(tl_Par_Legal.Text) && string.IsNullOrEmpty(tl_par_orgao.Text))
            {
                ...
                tl_Template.Text += "Steps Histórico de consultas: " + "\r\n" +
                    ...
                    "- Acesse a consulta de inicio" + tl_steps_consulta.Text+ "\r\n" + 
                    "*Veja que possui " + tl_Falhas.Text + " de falhas"+"\r\n" + "\r\n" +
        ...
        private void button_Limpar_Click(object sender, EventArgs e)
        {
            ...
            tl_par_orgao.Clear();
            tl_site.Clear();
            tl_steps_consulta.Clear();
            tl_Falhas.Clear();
            tl_Senha.Clear();
            tl_user.Text = "Support";
            comboPlano.SelectedIndex = 0;
            tl_Tenancy.Clear();
        }
    }
